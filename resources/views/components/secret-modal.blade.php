    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <code id="{{ $componentId }}-secret"
          class="api-key-secret-value border rounded p-3 mb-3">{{ $token }}</code>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-primary" data-api-key-copy="#{{ $componentId }}-secret">Copiar
          chave</button>
