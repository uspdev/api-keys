            ...
            <form method="POST" action="{{ $storeUrl }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="{{ $componentId }}-purpose" name="purpose" class="form-control @error('purpose') is-invalid @enderror" required>
                    ...
                    <div class="form-group">
                        ...
                        <select id="{{ $componentId }}-role" name="role" class="form-control @error('role') is-invalid @enderror" required>
